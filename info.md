...
```bash
$ git clone git@gitlab.com:uminho-di/li1/2223/2022li1g001.git
$ cd 2022li1g001
```
...
```bash
$ git clone https://gitlab.com/uminho-di/li1/2223/projetos/2022li1g001.git
$ cd 2022li1g001
```
...
- **A96227** Nuno de Freitas Machado Martins;
